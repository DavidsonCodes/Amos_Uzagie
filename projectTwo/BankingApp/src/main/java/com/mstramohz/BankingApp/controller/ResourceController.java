...
public class ResourceController {
    ...
    public ResponseEntity<AccountUserResource> getAccountResources(int id){
        ...
        Link delete = WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(AccountUserController.class).deleteAccUser(id)).withRel("delete");
        Link update = WebMvcLinkBuilder.linkTo(WebMvcLinkBuilder.methodOn(AccountUserController.class).updateAccUser(id, requestedUser)).withRel("update");
